...
def preprocess_save_to_queue(preprocess_fn, q, list_of_lists, output_files,
    ...
    for i, l in enumerate(list_of_lists):
        try:
            ...
            # while i!= len(list_of_lists) and not q.empty():
            #     pass
...
def preprocess_multithreaded(predictor,
    ...
    q = Queue(2)
    processes = []
    # preprocess_save_to_queue(predictor.preprocess_patient,q,
    #               list_of_lists,
    #               output_files,
    #               segs_from_prev_stage, classes,
    ...
    #     a = q.get()
    # return [a]
    preprocess_save_to_queue(predictor.preprocess_patient,
                q,
                list_of_lists,
                output_files,
                segs_from_prev_stage, classes,
